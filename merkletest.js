let Pool = require('b4bcore-p2p').Pool;
let BloomFilter = require('b4bcore-p2p').BloomFilter;
let NetworksData = require('@B4Bcoin/b4bcore-lib').Networks;
let Messages = require('b4bcore-p2p').Messages;
...
// Create a filter and a b4bcoin message with the filter
...
// Create a b4bcoin message for require a merkleblock
