 ...
 * using the standard b4bcoin protocol. A Peer instance represents one connection
 * on the b4bcoin network. To create a new peer connection provide the host and port
