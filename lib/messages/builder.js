...
function builder(options) {
  ...
  if (!options.network) {
    options.network = b4bcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || b4bcore.Block;
  options.BlockHeader = options.BlockHeader || b4bcore.BlockHeader;
  options.Transaction = options.Transaction || b4bcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || b4bcore.MerkleBlock;
